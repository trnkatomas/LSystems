...
QT_MOC_LITERAL(1, 10, 13), // "clickedSignal"
QT_MOC_LITERAL(2, 24, 0), // ""
QT_MOC_LITERAL(3, 25, 7), // "clicked"
QT_MOC_LITERAL(4, 33, 4), // "open"
QT_MOC_LITERAL(5, 38, 11), // "std::string"
QT_MOC_LITERAL(6, 50, 8), // "filename"
QT_MOC_LITERAL(7, 59, 4) // "save"

    },
    "Controler\0clickedSignal\0\0clicked\0open\0"
    "std::string\0filename\0save"
};
...
void Controler::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 2: _t->open((*reinterpret_cast< std::string(*)>(_a[1]))); break;
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Controler::clickedSignal)) {
                *result = 0;
            }
        }
    }
